...
When `cookies.json` contains both required values, Cryox Drive uses them immediately and writes a minimized private copy to the application-data directory. The source cookie export remains ignored by Git.
